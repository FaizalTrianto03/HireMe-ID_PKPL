...
class _Browse3ViewState extends State<Browse3View> {
  ...
  void initState() {
    super.initState();
    // Saved status is managed by SavedJobController via Obx in bottom bar
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              ClipRRect(
                ...
                child: widget.job.companyLogoPath.startsWith('http')
                    ? Image.network(
                        ...
                        width: 70,
                        fit: BoxFit.cover,
                        headers: widget.job.companyLogoPath
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 4),
                        Text(
                          'Start: ' + (widget.job.startDate != null ? _fmtDate(widget.job.startDate!) : '-'),
                        ...
                        const SizedBox(width: 4),
                        Text(
                          'End: ' + (widget.job.endDate != null ? _fmtDate(widget.job.endDate!) : '-'),
                          style: const TextStyle(fontSize: 12, color: Colors.black87),
                        ),
                      ],
                    ),
          ...
          _buildDatesStatus(widget.job.startDate, widget.job.endDate, widget.job.jobType),
        ],
      ),
    );
  }
                          ...
                          ClipRRect(
                            ...
                            child: companyDetails.companyGalleryPaths[index]
                                ...
                                ? Image.network(
                                    ...
                                    height: 180,
                                    fit: BoxFit.cover,
                                    headers: companyDetails.companyGalleryPaths[index]
                                            .contains('/remote.php/dav/files/')
                                        ? WebDAVService.authHeaders()
                                        : null,
                                    errorBuilder: (context, error, stackTrace) {
