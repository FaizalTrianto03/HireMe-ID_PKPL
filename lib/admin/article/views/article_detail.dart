...
class ArticleDetailView extends StatefulWidget {
  ...
  const ArticleDetailView({Key? key, required this.articleId}) : super(key: key);
...
class _ArticleDetailViewState extends State<ArticleDetailView> {
  ...
  Future<void> _load() async {
    ...
    final data = await controller.fetchArticleById(widget.articleId);
    setState(() {
      _article = data;
      _loading = false;
    });
  ...
  Widget build(BuildContext context) {
    ...
    final List<dynamic> media = List<dynamic>.from(article['media'] ?? []);
                  ...
                  if (media.length > 1)
                    Positioned(
                      ...
                      child: Obx(() => DotsIndicator(
                            ...
                            position: currentImageIndex.value,
